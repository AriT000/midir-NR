...
$Event(90575615, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(3.7);
...
$Event(90575616, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(2.3);
...
$Event(90575617, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(0.9);
...
$Event(90575618, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(5);
...
$Event(90575619, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(7);
...
$Event(90575620, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(2);
...
$Event(90575621, Default, function(chrEntityId) {
    DisableCharacter(chrEntityId);
    WaitFor(PlayerInMap(19, 0, 0, 0));
    WaitFor(EventFlag(7511));
    WaitFixedTimeSeconds(8);
